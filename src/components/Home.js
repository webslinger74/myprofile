        ...
        return (
            <div className="home">
                ...
                <div className="home__right">
                    ...
                    <h3><img src={webdev} style={{height:'100px',paddingLeft:'50px', borderRadius:'5px', width:'200px'}} xalt="image of pc" /></h3>
                    ...
                    and details about how to contact me.
                        ...
                        <div>
                            <h3><img src={javasc} style={{height:'200px',paddingLeft:'50px', borderRadius:'5px', width:'200px'}} xalt="image java icon" /></h3>
                        ...
                        <div>
                            <h3><img src={sass} style={{height:'200px',paddingLeft:'50px',borderRadius:'5px', width:'200px'}} xalt="image ofsass icon" /></h3>
                        ...
                        <div>
                            <h3><img src={reactImg} style={{height:'200px',paddingLeft:'50px',borderRadius:'5px', width:'300px'}} xalt="image of react icon" /></h3>
                        ...
                        <div>
                            <h3><img src={springImg} style={{height:'200px',marginLeft:'-40px',borderRadius:'5px', width:'400px'}} xalt="" /></h3>
                        ...
                        <div>
                            <h3><img src={reduxImg} style={{height:'300px',marginTop:'-50px',marginBottom:'-50px', paddingLeft:'50px',borderRadius:'5px', width:'400px'}} xalt="" /></h3>
